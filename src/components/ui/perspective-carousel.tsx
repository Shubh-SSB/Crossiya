...
export function PerspectiveCarousel({
  ...
  React.useEffect(() => {
    if (!autoPlay || isHovered || !items.length) return;
  ...
  }, [autoPlay, autoPlayInterval, isHovered, currentIndex, maxIndex, items.length, activeIndex, onActiveIndexChange]);
                ...
                >
                  ...
                  >
                    ...
                    <img
                      ...
                      draggable={false}
                      className={cn(
                        "h-full w-full select-none object-cover shadow-xl",
                        imageClassName
                      )}
                    />
                  </button>
